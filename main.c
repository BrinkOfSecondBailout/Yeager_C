...
//         "if (true print 5;",       // Should return "Compile Error" (syntax
//         error) NULL                        // Sentinel to end the loop
//     };
...
//         printf("Result: '%s'\n", result);
//         if (strcmp(result, outputBuffer) == 0 && result != "OK" && result !=
//         "Compile Error" && result != "Runtime Error") {
